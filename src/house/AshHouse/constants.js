...
// Flight A: runs north (-z) along the east wall
export const FLIGHT_A_X1 = HALF_W - MARGIN;
export const FLIGHT_A_X0 = FLIGHT_A_X1 - STAIR_WIDTH;
...
// Flight B: runs west (-x) along the north wall
export const FLIGHT_B_Z0 = LANDING_Z0;
export const FLIGHT_B_Z1 = LANDING_Z1;
export const FLIGHT_B_X1 = LANDING_X0;
export const STEP_DEPTH_B = STEP_DEPTH_A;
export const FLIGHT_B_X0 = FLIGHT_B_X1 - FLIGHT_B_STEPS * STEP_DEPTH_B;
