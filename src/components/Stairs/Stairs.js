...
import { STAIRS_CONFIG } from "./config.js";

/**
 * Visual L-shaped staircase: flight A → landing → flight B.
 * Purely visual/non-collidable.
 */
...
/**
 * Parapet walls guarding the two exposed long edges of each flight.
 */
...
/**
 * Returns the walkable surface height at local (x, z) and updates state.currentFloor.
 */
